...
_appendBlock:function(b,a){for(var c=$("<div></div>").addClass("en_Block").css("display","none"),d=a.elements,e=0;e<d.length;e++)this._appendElement(c,d[e]);b.append(c);return c},_appendElement:function(b,a){a.type==="title"?b.append($("<h1></h1>").addClass("en_Title").text(this._escVal(a.value)).css(a.style)):a.type==="text"?b.append($("<p></p>").addClass("en_Text").text(this._escVal(a.value)).css(a.style)):a.type==="link"?b.append($("<p></p>").addClass("en_Link").css(a.style).append($("<a></a>").attr("href",
a.href).text(this._escVal(a.value)))):a.type==="image"?b.append($("<img>").addClass("en_Image").css(a.style).attr("src",a.src)):a.type==="tag"&&b.append($("<div></div>").addClass("en_tag").append($(a.tag)))},_showBlock:function(b,a){b.css("display","block");typeof a.script==="function"&&a.script()},_showSlide:function(b,a){$(this.utl.base).append(b);b.css("display","block");this.current&&this.current.remove();typeof a.script==="function"&&a.script();this.current=b},_escVal:function(b){return b}}}();
...
Eggnog.Utility.prototype=function(b){return{_initialize:function(a,b){this.setSize(a,b);this.setTitle(this.slide.title)},setSize:function(a,c){a=a==="window"?this.windowWidth():a;c=c==="window"?this.windowHeight():c;this._calcSize(Number(a),Number(c));b(this.base).css({width:this.width+"px",height:this.height+"px"});b(document.body).css("fontSize",this.fontSize+"px")},setTitle:function(a){document.title=a||"Untitled"},windowWidth:function(){if(window.innerWidth)return window.innerWidth;else if(document.documentElement&&
document.documentElement.clientWidth!=0)return document.documentElement.clientWidth;else if(document.body)return document.body.clientWidth;return 0},windowHeight:function(){if(window.innerHeight)return window.innerHeight;else if(document.documentElement&&document.documentElement.clientHeight!=0)return document.documentElement.clientHeight;else if(document.body)return document.body.clientHeight;return 0},_calcSize:function(a,b){b*this.aspect<a?a=b*this.aspect:b=a/this.aspect;var d;this.width=a;this.height=
b;this.fontSize=b/10}}}(jQuery);
